<template>
	<view>
		<image mode="aspectFill" :src="icon_path" class="fixedView icon" @touchstart.stop="touchIcon" @touchmove.stop.prevent="moveIcon" @tap.stop="tapIcon"
		...
		mounted() {
			...
			if(this.iconPath == ""){
				...
				uni.getImageInfo({
					...
					fail(err) {
						that.$set(that,'icon_path','../../static/image/logo.png');
						uni.showModal({
							title:'错误',
...
<style scoped lang="scss">
	...
	.icon{
		...
		box-shadow: 0px 2px 5px #d0d0d0 !important;
	}
</style>
